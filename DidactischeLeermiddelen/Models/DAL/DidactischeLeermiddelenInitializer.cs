    ...
    public class DidactischeLeermiddelenInitializer : DropCreateDatabaseIfModelChanges<DidactischeLeermiddelenContext>
    {
        protected override void Seed(DidactischeLeermiddelenContext context)
        {
            try
            {
                ...
                Materiaal pincet = new Materiaal { AantalInCatalogus = 2, Plaats = "B3.039", ArtikelNr = 4444, MateriaalId = 4, Firma = b, Naam = "Pincet", ImageSrc = "C:\\Users\\ToonDT\\Desktop\\School 2015-2016\\Projecten\\DotNet\\DotNetProject\\DidactischeLeermiddelen\\Content\\Images\\pincet.jpg", Omschrijving = "Pincet Zwilling", Prijs = 6.95, Leergebieden = new List<Leergebied> { fysica, chemie }, Doelgroepen = new List<Doelgroep> { lagerOnderwijs, secundairOnderwijs }, IsReserveerBaar = true };
                Materiaal bordGeodriekhoek = new Materiaal { AantalInCatalogus = 15, AantalOnbeschikbaar = 7, Plaats = "B2.012", ArtikelNr = 5555, MateriaalId = 5, Firma = c, Naam = "Bordgeodriehoek", ImageSrc = "C:\\Users\\ToonDT\\Desktop\\School 2015-2016\\Projecten\\DotNet\\DotNetProject\\DidactischeLeermiddelen\\Content\\Images\\geodriehoek.jpg", Omschrijving = "Geodriehoek om op het bord te gebruiken", Prijs = 16.00, Leergebieden = new List<Leergebied> { wiskunde, fysica, chemie }, Doelgroepen = new List<Doelgroep> { lagerOnderwijs, secundairOnderwijs }, IsReserveerBaar = true };
                Materiaal ReddingsPop = new Materiaal { AantalInCatalogus = 5, Plaats = "B4.009", ArtikelNr = 6666, MateriaalId = 6, Firma = f, Naam = "Reddingspop", ImageSrc = "C:\\Users\\ToonDT\\Desktop\\School 2015-2016\\Projecten\\DotNet\\DotNetProject\\DidactischeLeermiddelen\\Content\\Images\\reddingspop.jpg", Omschrijving = "Met behulp van deze pop wordt je een geweldig duiker", Prijs = 245.00, Doelgroepen = new List<Doelgroep> { lagerOnderwijs, secundairOnderwijs }, Leergebieden = new List<Leergebied> { LO }, IsReserveerBaar = false };
                Materiaal Basketbal = new Materiaal { AantalInCatalogus = 30, Plaats = "B1.012", ArtikelNr = 7777, MateriaalId = 7, Firma = b, Naam = "Spalding basketbal", ImageSrc = "C:\\Users\\ToonDT\\Desktop\\School 2015-2016\\Projecten\\DotNet\\DotNetProject\\DidactischeLeermiddelen\\Content\\Images\\basketbal.jpg", Omschrijving = "Officiële NBA basketbal, hiermee scoort iedereen 3-punters", Prijs = 169.00, Doelgroepen = new List<Doelgroep> { lagerOnderwijs, secundairOnderwijs }, Leergebieden = new List<Leergebied> { LO }, IsReserveerBaar = false };
                Materiaal Bok = new Materiaal { AantalInCatalogus = 1, Plaats = "B3.039", ArtikelNr = 8888, MateriaalId = 8, Firma = c, Naam = "Bok", ImageSrc = "C:\\Users\\ToonDT\\Desktop\\School 2015-2016\\Projecten\\DotNet\\DotNetProject\\DidactischeLeermiddelen\\Content\\Images\\bok.jpg", Omschrijving = "Niet de alledaagse bok van in de turnles", Prijs = 0.00, Doelgroepen = new List<Doelgroep> { lagerOnderwijs, secundairOnderwijs, kleuterOnderwijs }, Leergebieden = new List<Leergebied> { LO }, IsReserveerBaar = true };
                Materiaal Duitser = new Materiaal { AantalInCatalogus = 21, Plaats = "B4.009", ArtikelNr = 9999, MateriaalId = 9, Firma = f, Naam = "Woordenboek Duits-Nederlands", ImageSrc = "C:\\Users\\ToonDT\\Desktop\\School 2015-2016\\Projecten\\DotNet\\DotNetProject\\DidactischeLeermiddelen\\Content\\Images\\woordenboek.jpg", Omschrijving = "Pocketwoordenboek Nederlands Duits", Prijs = 13.00, Doelgroepen = new List<Doelgroep> { secundairOnderwijs }, Leergebieden = new List<Leergebied> { Duits }, IsReserveerBaar = false };
