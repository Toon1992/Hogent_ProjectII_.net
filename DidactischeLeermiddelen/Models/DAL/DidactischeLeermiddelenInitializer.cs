    ...
    public class DidactischeLeermiddelenInitializer : DropCreateDatabaseAlways<DidactischeLeermiddelenContext>
    {
        protected override void Seed(DidactischeLeermiddelenContext context)
        {
            try
            {
                ...
                Materiaal microscoopCeti = new Materiaal { AantalInCatalogus = 2, ArtikelNr = 6721, MateriaalId = 3, Firma = "Ceti", Naam = "Microscoop Ceti", Foto = "/Content/Images/microscoopCeti.jpg", Omschrijving = "Microscoop Ceti", Prijs = 534.00M, Status = Status.Catalogus, Leergebieden = new List<Leergebied> { chemie }, Doelgroepen = new List<Doelgroep> { secundairOnderwijs }, IsReserveerBaar = true, ReservatieData = new List<ReservatieData> { reservatieData1, reservatieData3 } };
                ...
                Materiaal Bok = new Materiaal { AantalInCatalogus = 2, ArtikelNr = 2441, MateriaalId = 8, Firma = "Moeder natuur", Naam = "Bok", Foto = "/Content/Images/bok.jpg", Omschrijving = "Niet de alledaagse bok van in de turnles", Prijs = 0.00M, Status = Status.TeLaat, Doelgroepen = new List<Doelgroep> { lagerOnderwijs, secundairOnderwijs,kleuterOnderwijs }, Leergebieden = new List<Leergebied> { LO }, IsReserveerBaar = true, ReservatieData = new List<ReservatieData> { reservatieData2, reservatieData4 } };
                Materiaal Duitser = new Materiaal { AantalInCatalogus = 1, ArtikelNr = 9812, MateriaalId = 9, Firma = "Prisma", Naam = "Woordenboek Duits-Nederlands", Foto = "/Content/Images/woordenboek.jpg", Omschrijving = "Pocketwoordenboek Nederlands Duits", Prijs = 13.00M, Status = Status.Geblokkeerd, Doelgroepen = new List<Doelgroep> { secundairOnderwijs }, Leergebieden = new List<Leergebied> { Duits }, IsReserveerBaar = false, ReservatieData = new List<ReservatieData> { reservatieData2, reservatieData4 } };
